...
ActiveRecord::Schema.define(version: 2024_01_28_053236) do
  ...
  create_table "payment_dmer_senbais", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    ...
    t.date "payment", null: false
    t.integer "price", null: false
    t.index ["dmer_senbai_id"], name: "index_payment_dmer_senbais_on_dmer_senbai_id"
  end
  ...
  create_table "payment_rakuten_pays", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", options: "ENGINE=InnoDB ROW_FORMAT=DYNAMIC", force: :cascade do |t|
    ...
    t.integer "price"
    t.date "payment", null: false
    t.index ["rakuten_pay_id"], name: "index_payment_rakuten_pays_on_rakuten_pay_id"
  end
  ...
  add_foreign_key "payment_dmer_senbais", "dmer_senbais"
